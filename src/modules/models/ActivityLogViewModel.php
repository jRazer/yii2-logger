...
use jrazer\activityLogger\modules\Module;

/**
 * Class ActivityLogViewModel
 * @package jrazer\activityLogger\modules\models
 */
class ActivityLogViewModel extends ActivityLog
{
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            'entityName' => Yii::t('jrazer/logger', 'Entity name'),
            'userName' => Yii::t('jrazer/logger', 'User name'),
        ]);
    }
    ...
    public function getData()
    {
        foreach (parent::getData() as $attribute => $values) {
            if (is_string($values)) {
                ...
                yield $label => Html::encode(Yii::t('jrazer/logger', $values));
            } else {
